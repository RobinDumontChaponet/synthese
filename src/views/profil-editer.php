		...
		<section id="entreprises">
			...
			<ul>
				<?php if($entreprises != NULL) { // Il faudra faire quelque chose pour pouvoir les modifiers, soit là, soit sur une autre page
					...
					<li>
						<a class="edit" href="entreprise-modifier/<?php echo $ancien->getId(); ?>&<?php echo $entreprise->getEntreprise()->getId();?>&<?php echo $entreprise->getDateEmbaucheDeb()?>&<?php echo $entreprise->getDateEmbaucheFin()?>&<?php echo $entreprise->getPoste()->getId();?>">Éditer</a><a class="edit" href="index.php?requ=entreprise-selectionner-supprimer&idEntreprise=<?php echo $entreprise->getEntreprise()->getId();?>&idAncien=<?php echo $ancien->getId(); ?>&idPoste=<?php echo $entreprise->getPoste()->getId(); ?>&dateDebut=<?php echo $entreprise->getDateEmbaucheDeb(); ?>">Supprimer</a>
