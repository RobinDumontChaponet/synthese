...
<?php if(!empty($output)) { ?>
  ...
  <form action="index.php?requ=csv-import&<?php echo http_build_query($order);?>&promotion=<?= ($promotion!=NULL)?$promotion->getId():'' ?>&departement=<?= ($departement!=NULL)?$departement->getId():'' ?>" method="post" name="correct">
  	<?php echo $output; ?>
...
?>
	...
	<form action="index.php?requ=csv-import&<?php echo http_build_query($order);?>&promotion=<?= ($promotion!=NULL)?$promotion->getId():'' ?>&departement=<?= ($departement!=NULL)?$departement->getId():'' ?>" method="post" name="final">
