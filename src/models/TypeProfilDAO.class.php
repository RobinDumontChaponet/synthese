...
class TypeProfilDAO {
	...
	public static function getById($id) {
		try{
			...
			die("Error getById TypeProfil !: " . $e->getMessage() . "<br/>");
		}
	}

	public static function getByLibelle($libelle) {
		try{
			$req=SPDO::getInstance()->prepare("SELECT `idProfil`, `libelle` FROM `typeProfil` WHERE libelle=?");
			...
			die("Error getByLibelle TypeProfil !: " . $e->getMessage() . "<br/>");
		}
	}
