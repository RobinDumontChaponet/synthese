...
if($_SESSION["syntheseUser"]) {
	...
	if($user_auth['read']) {
		...
		$suggestions = AncienDAO::search($_GET['nom'], $_GET['prenom'], array($_GET['promotionInf'], $_GET['promotionSup']), $_GET['diplomeDUT'], $_GET['typeSpecialisation'], $_GET['specialisation'], $_GET['diplomePostDUT'], $_GET['etablissementPostDUT'], $_GET['travailActuel']);
